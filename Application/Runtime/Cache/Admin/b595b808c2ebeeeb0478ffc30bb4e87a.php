...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="<?php echo U('Article/edit');?>">发布文章</a>
                            </li>
                            <li><a class="J_menuItem" href="<?php echo U('Article/articleList');?>">文章</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="<?php echo U('Http/httpAdd');?>">增加友链</a>
                            </li>
                            <li><a class="J_menuItem" href="<?php echo U('Http/httpList');?>">友链</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                     ...
                     <li>
                       ...
                       <li>
                        <a class="J_menuItem" href="<?php echo U('Black/index');?>"><i class="fa fa-magic"></i> <span class="nav-label">黑名单</span></a>
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="footer">
                <div class="pull-right">&copy; 2016-2017 <a href="http://jh12.cn" target="_blank">J.H & Blog</a>
                </div>
            </div>
        </div>
